...
# write.csv(pop_table, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Table1_steroids_sensitivity.csv",
#           row.names = FALSE)
...
# 
# 
# saveRDS(analyses_df_unadj_Wald, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_steroids_sensitivity.RDS")
# saveRDS(analyses_df_unadj_profile, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_steroids_sensitivity.RDS")
# saveRDS(analyses_df_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_steroids_sensitivity.RDS")
# saveRDS(model_output_list_unadj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_steroids_sensitivity.RDS")
# saveRDS(model_output_list_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_steroids_sensitivity.RDS")

analyses_df_unadj_Wald <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_steroids_sensitivity.RDS")
analyses_df_unadj_profile <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_steroids_sensitivity.RDS")
analyses_df_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_steroids_sensitivity.RDS")
model_output_list_unadj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_steroids_sensitivity.RDS")
model_output_list_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_steroids_sensitivity.RDS")
...
# write.csv(clean_unadj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Supplemental_table_1_steroids_sensitivity.csv",
#           row.names = FALSE)
...
saveRDS(analyses_df_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_steroids_sensitivity.RDS")
saveRDS(analyses_df_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_steroids_sensitivity.RDS")
saveRDS(model_output_list_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_steroids_sensitivity.RDS")
saveRDS(model_output_list_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_steroids_sensitivity.RDS")




analyses_df_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_steroids_sensitivity.RDS")
analyses_df_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_steroids_sensitivity.RDS")
model_output_list_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_steroids_sensitivity.RDS")
model_output_list_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_steroids_sensitivity.RDS")
...
saveRDS(analyses_df_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_steroids_sensitivity.RDS")
saveRDS(analyses_df_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_steroids_sensitivity.RDS")
saveRDS(model_output_list_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_steroids_sensitivity.RDS")
saveRDS(model_output_list_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_steroids_sensitivity.RDS")


analyses_df_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_steroids_sensitivity.RDS")
analyses_df_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_steroids_sensitivity.RDS")
model_output_list_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_steroids_sensitivity.RDS")
model_output_list_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_steroids_sensitivity.RDS")
...
write.csv(clean_adj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Clean_adjusted_results_table_steroids_sensitivity.csv",
          row.names = FALSE)
...
# write.csv(clean_BPT, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/BPT2024_full_results_read_steroids_sensitivity.csv",
#           row.names = FALSE)
...
saveRDS(model_all_DB_indiv, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_steroids_sensitivity.RDS")
saveRDS(model_all_DB_indiv_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_glm_steroids_sensitivity.RDS")
...
saveRDS(dom_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read30_steroids_sensitivity.RDS")
...
saveRDS(dom_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read90_steroids_sensitivity.RDS")
...
saveRDS(dom_asthma_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read30_steroids_sensitivity.RDS")
...
saveRDS(dom_asthma_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read90_steroids_sensitivity.RDS")
