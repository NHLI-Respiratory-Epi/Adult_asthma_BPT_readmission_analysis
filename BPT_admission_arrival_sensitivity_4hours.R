...
dat$RSR_BPT_bin[dat$arrival_to_RSR_hours < 32] <- 1
...
for (i in c(1, 2, 16, 17, 31, 32, 46, 47)) { # for BPT/RSR 32 HOUR SENSITIVTY
...
BPT_RSR_32hour_unadj <- analyses_df_unadj_Wald

saveRDS(BPT_RSR_32hour_unadj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/BPT_RSR_32hour_analyses_df_unadj_Wald.RDS")
...
for (i in c(1, 2, 15, 16, 29, 30, 43, 44)) { # for BPT/RSR 32 HOUR SENSITIVTY
...
BPT_RSR_32hour_adj <- analyses_df_adj

saveRDS(BPT_RSR_32hour_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/BPT_RSR_32hour_analyses_df_adj.RDS")
summary(model_output_list_adj[[15]])
summary(model_output_list_adj_glm[[15]])

saveRDS(model_output_list_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_BPT_RSR_32hour.RDS")
saveRDS(model_output_list_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_BPT_RSR_32hour.RDS")

clean_adj_analyses <- BPT_RSR_32hour_adj %>% filter(!is.na(est))
...
write.csv(clean_adj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Clean_adjusted_results_table_BPT_RSR_32hours.csv",
          row.names = FALSE)
