...
dat <- dat %>% filter(discharge_bundle %in% c("Yes", "No"))
...
# write.csv(pop_table, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Table1_sensitivity_no_selfdischarge.csv",
#           row.names = FALSE)
...
saveRDS(analyses_df_unadj_Wald, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_sensitivity_no_selfdischarge.RDS")
saveRDS(analyses_df_unadj_profile, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_sensitivity_no_selfdischarge.RDS")
saveRDS(analyses_df_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_unadj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_sensitivity_no_selfdischarge.RDS")

# analyses_df_unadj_Wald <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_sensitivity_no_selfdischarge.RDS")
# analyses_df_unadj_profile <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_sensitivity_no_selfdischarge.RDS")
# analyses_df_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_sensitivity_no_selfdischarge.RDS")
# model_output_list_unadj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_sensitivity_no_selfdischarge.RDS")
# model_output_list_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_sensitivity_no_selfdischarge.RDS")
...
write.csv(clean_unadj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Supplemental_table_1_sensitivity_no_selfdischarge.csv",
          row.names = FALSE)
...
saveRDS(analyses_df_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_sensitivity_no_selfdischarge.RDS")
saveRDS(analyses_df_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_sensitivity_no_selfdischarge.RDS")

# 
# analyses_df_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_sensitivity_no_selfdischarge.RDS")
# analyses_df_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_sensitivity_no_selfdischarge.RDS")
# model_output_list_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_sensitivity_no_selfdischarge.RDS")
# model_output_list_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_sensitivity_no_selfdischarge.RDS")
...
saveRDS(analyses_df_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_sensitivity_no_selfdischarge.RDS")
saveRDS(analyses_df_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_sensitivity_no_selfdischarge.RDS")
saveRDS(model_output_list_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_sensitivity_no_selfdischarge.RDS")

# 
# analyses_df_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_sensitivity_no_selfdischarge.RDS")
# analyses_df_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_sensitivity_no_selfdischarge.RDS")
# model_output_list_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_sensitivity_no_selfdischarge.RDS")
# model_output_list_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_sensitivity_no_selfdischarge.RDS")
...
write.csv(clean_adj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/Clean_adjusted_results_table_sensitivity_no_selfdischarge.csv",
          row.names = FALSE)
...
write.csv(clean_BPT, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Tidy results/BPT2024_full_results_read_sensitivity_no_selfdischarge.csv",
          row.names = FALSE)
...
saveRDS(model_all_DB_indiv, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_sensitivity_no_selfdischarge.RDS")
saveRDS(model_all_DB_indiv_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_glm_sensitivity_no_selfdischarge.RDS")
...
saveRDS(dom_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read30_sensitivity_no_selfdischarge.RDS")
...
saveRDS(dom_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read90_sensitivity_no_selfdischarge.RDS")
...
saveRDS(dom_asthma_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read30_sensitivity_no_selfdischarge.RDS")
...
saveRDS(dom_asthma_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read90_sensitivity_no_selfdischarge.RDS")
