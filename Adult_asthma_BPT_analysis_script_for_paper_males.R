...
write.csv(pop_table, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/Table1.csv",
          row.names = FALSE)
...
write.csv(FU_table_combos, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/Follow-up_focus_table.csv",
          row.names = FALSE)
...
write.csv(rough_heatmap, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/rough_heatmap_data.csv",
          row.names = FALSE)
...
saveRDS(analyses_df_unadj_Wald, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_males.RDS")
saveRDS(analyses_df_unadj_profile, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_males.RDS")
saveRDS(analyses_df_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_males.RDS")
saveRDS(model_output_list_unadj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_males.RDS")
saveRDS(model_output_list_unadj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_males.RDS")

analyses_df_unadj_Wald <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_unadj_Wald_males.RDS")
analyses_df_unadj_profile <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_profile_males.RDS")
analyses_df_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_glm_males.RDS")
model_output_list_unadj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_males.RDS")
model_output_list_unadj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_unadj_glm_males.RDS")
...
write.csv(clean_unadj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/Supplemental_table_1.csv",
          row.names = FALSE)
...
saveRDS(analyses_df_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_males.RDS")
saveRDS(analyses_df_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_males.RDS")
saveRDS(model_output_list_adj, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_males.RDS")
saveRDS(model_output_list_adj_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_males.RDS")




analyses_df_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_males.RDS")
analyses_df_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/analyses_df_adj_glm_males.RDS")
model_output_list_adj <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_males.RDS")
model_output_list_adj_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_output_list_adj_glm_males.RDS")
...
saveRDS(analyses_df_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_males.RDS")
saveRDS(analyses_df_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_males.RDS")
saveRDS(model_output_list_adj_smoking, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_males.RDS")
saveRDS(model_output_list_adj_smoking_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_males.RDS")


analyses_df_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_males.RDS")
analyses_df_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/analyses_df_adj_smoking_glm_males.RDS")
model_output_list_adj_smoking <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_males.RDS")
model_output_list_adj_smoking_glm <- readRDS("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/model_output_list_adj_smoking_glm_males.RDS")
...
write.csv(clean_adj_analyses, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/Clean_adjusted_results_table.csv",
          row.names = FALSE)
...
# write.csv(clean_BPT, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/BPT2024_full_results_read.csv",
#           row.names = FALSE)
...
ggsave("G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/Disaggregated results/Males/adj_odds_ratios.pdf",
...
saveRDS(model_all_DB_indiv, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_males.RDS")
saveRDS(model_all_DB_indiv_glm, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/model_all_DB_indiv_glm_males.RDS")
...
saveRDS(dom_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read30_males.RDS")
...
saveRDS(dom_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_read90_males.RDS")
...
saveRDS(dom_asthma_read30, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read30_males.RDS")
...
saveRDS(dom_asthma_read90, "G:/Alex Harley/Audit_2023_onwards/2022-2023/Research/Adult_asthma_BPT/Analysis/Output/Analysis for paper/dom_asthma_read90_males.RDS")
